#!/usr/bin/env python3
"""
Wrappers for the Kakadu HT codec.
...
class Kakadu2DHT(icompression.WrapperCodec, icompression.LosslessCodec, icompression.LossyCodec):
...
class Kakadu2DHaarHT(Kakadu2DHT, icompression.LosslessCodec):
...
class Kakadu2D97MHT(Kakadu2DHT, icompression.LosslessCodec):
