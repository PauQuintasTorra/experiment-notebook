#!/usr/bin/env python3
"""Codec wrapper for the Adaptative Words montsec software
"""
__author__ = "Xavier Fernandez Mellado and Pau Quintas Torra"
__since__ = "2025/10/17"
...
class MontsecAW(enb.icompression.LosslessCodec, enb.icompression.NearLosslessCodec,
              enb.icompression.JavaWrapperCodec, enb.icompression.GiciLibHelper):
    """Wrapper for the Adaptative Words montsec codec
    """
